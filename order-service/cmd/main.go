...
import (
	...
	"github.com/ajitirto/ms/order-service/internal/infrastructure/postgres"
	"github.com/ajitirto/ms/order-service/internal/usecase"
	"github.com/ajitirto/ms/order-service/pkg/server"
...
func main() {
	...
	orderHandler := server.NewOrderHandler(orderUC)

	http.HandleFunc("/", orderHandler.StatusHandler)
	http.HandleFunc("/orders", orderHandler.HandleOrders)  
	http.HandleFunc("/orders/", orderHandler.GetOrderByID) 
